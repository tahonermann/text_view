#if !defined(STDTEXT_CODECS_UTF32LE_CODEC_HPP) // {
#define STDTEXT_CODECS_UTF32LE_CODEC_HPP
...
struct utf32le_codec {
        ...
        int &encoded_code_units)
    {
        ...
        code_unit_type roctet4 = (cp >>  0) & 0xFF;
        code_unit_type roctet3 = (cp >>  8) & 0xFF;
        code_unit_type roctet2 = (cp >> 16) & 0xFF;
        code_unit_type roctet1 = (cp >> 24) & 0xFF;
...
#endif // } STDTEXT_CODECS_UTF32LE_CODEC_HPP
